...
let shellydimmer2 = {
  ...
  'lights.Input1': {
    ...
    mqtt: {
      ...
      mqtt_publish_funct: async (value, self) => { if (value == 0) { shellyHelper.setValueForId(self, 'lights.longpush1', false); return false; } else { return true; } },
    },
  ...
  'lights.longpush1': {
    ...
    mqtt: {
      mqtt_publish: 'shellies/shellydimmer2-<deviceid>/input_event/0',
      mqtt_publish_funct: (value) => {return JSON.parse(value).event === "L" ? true : false; },
  ...
  'lights.Input2': {
    ...
    mqtt: {
      ...
      mqtt_publish_funct: async (value, self) => { if (value == 0) { shellyHelper.setValueForId(self, 'lights.longpush2', false); return false; } else { return true; } },
    },
    common: {
      'name': 'Input / Detach',
      'type': 'boolean',
  ...
  'lights.longpush2': {
    ...
    mqtt: {
      ...
      mqtt_publish_funct: (value) => { if (value == 1) { shellyHelper.setValueForId(self, 'lights.longpush2', false); }},
    },
    common: {
      'name': 'Longpush',
      'type': 'boolean',
