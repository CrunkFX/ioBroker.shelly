...
let shellydimmer2 = {
  ...
  'lights.Input1': {
    ...
    mqtt: {
      ...
      mqtt_publish_funct: (value, self) => { if (value == 0) { shellyHelper.setValueForId(self, 'lights.longpush1', false); return false; } else { return true; } },
    },
  ...
  'lights.Input2': {
    ...
    mqtt: {
      ...
      mqtt_publish_funct: (value, self) => { if (value == 0) { shellyHelper.setValueForId(self, 'lights.longpush2', false); return false; } else { return true; } },
